...
\begin{itemize}
    ...
    \item We present the detailed design and implementation of \ours{}, an end-to-end decentralized analytics platform with secure in-enclave query processing. The source code is available for reproducibility. 
\end{itemize}
